...
namespace PRS.PatientService.Grpc {
  public static partial class PatientGrpc
  {
    ...
    /// <summary>Base class for server-side implementations of PatientGrpc</summary>
    [grpc::BindServiceMethod(typeof(PatientGrpc), "BindService")]
    public abstract partial class PatientGrpcBase
    {
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public virtual global::System.Threading.Tasks.Task<global::PRS.PatientService.Grpc.PatientExistsResponse> CheckPatientExists(global::PRS.PatientService.Grpc.PatientRequest request, grpc::ServerCallContext context)
      {
